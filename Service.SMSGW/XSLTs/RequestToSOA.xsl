  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      ...
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:param name="cacheValue"/>
      </oracle-xsl-mapper:source>
    </oracle-xsl-mapper:mapSources>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [THU NOV 28 20:49:56 ICT 2019].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="cacheValue"/>
  <xsl:template match="/">
    <ns0:request>
      <ns0:Parameters>
        <!--Check date active of PKG and PROG -->
        <!--0 is block; 1: is bypass; 2: is bpass + use prog -->
        <ns0:Parameter>
          <ns0:name>
            <xsl:value-of select="'ACTION_PKG_PROG'"/>
          </ns0:name>
          <ns0:value>
            <!--PKG-->
            <xsl:choose>
        ...
        <!--END date active of PKG and PROG -->
        ...
        <xsl:for-each select="$cacheValue/ns0:CacheValue/ns0:Parameters/ns0:Parameter">
          <ns0:Parameter>
            <ns0:name>
              <xsl:value-of select="ns0:name"/>
            </ns0:name>

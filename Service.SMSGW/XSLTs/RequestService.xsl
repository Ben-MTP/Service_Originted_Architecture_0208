   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         ...
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:param name="requestInput"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [FRI NOV 22 12:30:27 ICT 2019].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:param name="requestInput"/>
   <xsl:template match="/">
      <ns0:request>
         <ns0:Parameters>
            <xsl:for-each select="$requestInput/ns0:request/ns0:Parameters/ns0:Parameter">
               <ns0:Parameter>
                  <ns0:name>
            ...
            <xsl:for-each select="/ns0:XMLCacheEntry/ns0:CacheValue/ns0:Parameters/ns0:Parameter">
               <ns0:Parameter>
                  <ns0:name>
                     <xsl:value-of select="ns0:name"/>
                  </ns0:name>

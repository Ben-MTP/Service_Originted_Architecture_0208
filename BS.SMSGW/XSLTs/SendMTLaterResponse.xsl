...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.oracle.com/pcbpel/adapter/db/sp/SendSMSMTLater"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="OutputParameters"
                                       namespace="http://xmlns.oracle.com/pcbpel/adapter/db/sp/SendSMSMTLater"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [SUN DEC 22 17:30:46 ICT 2019].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:response>
      <xsl:choose>
        <xsl:when test="/ns0:OutputParameters/ns0:ADD_SMSMT_LATER = '1'">
          <tns:STATUS>
        ...
        <xsl:otherwise>
          ...
          <tns:STATUS_MESSAGE>
            <xsl:value-of select="/ns0:OutputParameters/ns0:ADD_SMSMT_LATER"/>
          </tns:STATUS_MESSAGE>
        </xsl:otherwise>
      </xsl:choose>
      <tns:Parameters>

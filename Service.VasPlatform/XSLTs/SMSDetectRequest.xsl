   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../Schemas/NEOFormat.xsd"/>
            <oracle-xsl-mapper:rootElement name="ChargeLeRequest" namespace="http://vasplatform.mobifone.vn"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [MON JAN 13 16:21:35 ICT 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:ChargeLeRequest>
         <ns0:SERVICE_CMD>
            <xsl:value-of select="/ns0:request/ns0:Parameters/ns0:Parameter[ns0:name = 'SERVICE_CMD']/ns0:value"/>
         </ns0:SERVICE_CMD>
         <ns0:SERVICE_CODE>

...
<xsl:stylesheet version="1.0"
    ...
    <oracle-xsl-mapper:schema>
        ...
        <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [WED NOV 13 23:21:56 ICT 2019].-->
    </oracle-xsl-mapper:schema>
    <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
    <xsl:template match="/">
        <!-- Write the entire content of "books" element using translator -->
        <xsl:variable name="username" select="socket:socketWrite('12312312312','terminated','terminatedBy=\n')"/>

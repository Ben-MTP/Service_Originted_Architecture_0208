  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="getReverseResponse" namespace="http://vasplatform.mobifone.vn"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [TUE DEC 31 20:17:36 ICT 2019].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <ns0:response>
      <xsl:choose>
        <xsl:when test="/ns0:getReverseResponse/ns0:MSISDN">
          <ns0:STATUS>
          ...
          <ns0:Parameters>
            <ns0:Parameter>
              ...
              <ns0:value>
                <xsl:value-of select="/ns0:getReverseResponse/ns0:MSISDN"/>
              </ns0:value>
            </ns0:Parameter>
            <ns0:Parameter>
              <ns0:name>
              ...
              <ns0:value>
                <xsl:value-of select="/ns0:getReverseResponse/ns0:SERVICE_ID"/>
              </ns0:value>
            </ns0:Parameter>
          </ns0:Parameters>
        </xsl:when>
        <xsl:otherwise>
          ...
          <ns0:STATUS_MESSAGE>
            <xsl:value-of select="'Không tìm thấy số thuê bao từ Sub-id'"/>
          </ns0:STATUS_MESSAGE>
        </xsl:otherwise>
      </xsl:choose>
    </ns0:response>

...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [TUE NOV 12 13:56:54 ICT 2019].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <xsl:variable name="v_key" select="//ns0:XMLCacheEntry/ns0:CacheKey"/>
    <ns0:response>
      <ns0:STATUS>
        <xsl:choose>
          <xsl:when test="$v_key">
      ...
      <xsl:choose>
        <xsl:when test="$v_key">
          ...
          <ns0:CacheValue>
            <xsl:copy-of select="//ns0:XMLCacheEntry/ns0:CacheValue/ns0:Parameters"/>
          </ns0:CacheValue>
        </xsl:when>
      </xsl:choose>
    </ns0:response>

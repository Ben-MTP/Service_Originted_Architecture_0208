...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.oracle.com/pcbpel/adapter/coherence/Remove/response"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        <oracle-xsl-mapper:schema location="../Resources/RemoveResponse.xsd"/>
        <oracle-xsl-mapper:rootElement name="RemoveResponse"
                                       namespace="http://xmlns.oracle.com/pcbpel/adapter/coherence/Remove/response"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [TUE NOV 12 14:12:53 ICT 2019].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <xsl:variable name="v_key" select="//*:RemoveResponse/*:Count"/>
    <tns:response>
      <tns:STATUS>
        <xsl:choose>
          <xsl:when test="$v_key">
